...
public class Homem extends Pessoa {
	...
	public Homem(String nome, String sobrenome, String diaNasc, String mesNasc, String anoNasc, long numCPF, float peso,
			float altura) {
	...
	public String toString() {
		return String.format("Nome: %s %s, Idade: %d, Peso: %.2f, Altura: %.2f, CPF: %s, Gênero: %s", getNome(), getSobrenome(),
				calcularIdade(), getPeso(), getAltura(), getNumCPF(), "Homem");
	}
